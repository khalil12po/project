...
if (empty($_POST["LIemail"])) {
    $errors .= $missingEmail;
} else {
    $email = filter_var($_POST["LIemail"], FILTER_SANITIZE_EMAIL);
}
if (empty($_POST["LIpassword"])) {
    $errors .= $missingPassword;
} else {
    $password = filter_var($_POST["LIpassword"], FILTER_SANITIZE_STRING);
}
