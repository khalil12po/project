...
if (empty($_POST["FPemail"])) {
    ...
    $email = filter_var($_POST["FPemail"], FILTER_SANITIZE_EMAIL);
...
$message .= "http://localhost/testphp/noteapp/resetpassword.php?user_id=$user_id&key=$key";
if (mail($email, 'Reset your password', $message, 'From:' . 'khalil.younsi16@gmail.com')) {
