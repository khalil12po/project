    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-offset-1 col-sm-10 contactForm">
                ...
                //klin the variables to prevent any sql ingection
                $user_id = mysqli_real_escape_string($link, $user_id);
                $key = mysqli_real_escape_string($link, $key);
                //Run Query: Check combination of user_id & key exists and less than 24h old
                $sql = "SELECT  `user_id`FROM `forgotpassword` WHERE `key`='$key' AND`user_id`='$user_id'
                ...
                if ($count !== 1) {
                    echo '<div class="alert alert-danger">Please try again1234.</div>';
                    exit;
                }
